...
import { ANOMALY_TEST_DATA, COLORS, featureInfluence, NORMAL_TEST_DATA, SAMPLE_DATA } from "./utils/constants.js";
    ...
    <div className="app-shell">
      <div className="page">
        ...
        <div className="content-grid">
          <DataSourcePanel onFile={handleFile} onLoadSample={loadSample} onLoadTestScenario={loadTestScenario} />
        ...
        <FeatureInfluence items={featureInfluence} />
        <SystemLogic />
        <BottomInfoCards />
      </div>
    </div>
